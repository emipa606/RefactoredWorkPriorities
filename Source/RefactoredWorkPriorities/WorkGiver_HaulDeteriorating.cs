...
namespace RWP
{
	...
	public class WorkGiver_HaulDeteriorating : WorkGiver_HaulGeneral
	{
		...
		{
			return 100f * (float)t.HitPoints / (float)t.MaxHitPoints >= (float)Settings.DeterioratableMinHealthPercent && base.HasJobOnThing(pawn, t, false);
		}
		...
		public override IEnumerable<Thing> PotentialWorkThingsGlobal(Pawn pawn)
		{
			...
			where t.GetStatValue(StatDefOf.DeteriorationRate, true) > 0f && t.Position.GetRoof(t.Map) == null
			select t;
		}
